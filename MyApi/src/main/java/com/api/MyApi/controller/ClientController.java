...
import com.api.MyApi.service.ClientService;
import com.api.MyApi.utils.CustomMetricsServiceCounter;
...
public class ClientController {
    ...
    private final CustomMetricsServiceCounter customMetricsService;

    @Autowired
    public ClientController(ClientService clientService, CustomMetricsServiceCounter customMetricsService) {
